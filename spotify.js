...
function playlistInfo(data) {
    ...
    $("#acousticness-value").html((averages.acousticness * 100).toFixed(0) + "%");
    $("#acousticness-value").slideUp(1000)
        .delay(5)
        .slideDown(2000);
    $("#danceability-value").html((averages.danceability * 100).toFixed(0) + "%");
    $("#danceability-value").slideUp(1000)
        .delay(5)
        .slideDown(2000);
    $("#energy-value").html((averages.energy * 100).toFixed(0) + "%");
    $("#energy-value").slideUp(1000)
        .delay(5)
        .slideDown(2000);
    $("#speechiness-value").html((averages.speechiness * 100).toFixed(0) + "%");
    $("#speechiness-value").slideUp(1000)
        .delay(5)
        .slideDown(2000);
    $("#liveness-value").html((averages.liveness * 100).toFixed(0) + "%");
    $("#liveness-value").slideUp(1000)
        .delay(5)
        .slideDown(2000);
    $("#valence-value").html((averages.valence * 100).toFixed(0) + "%");
